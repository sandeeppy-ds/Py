...
#using global variables as arguments to the function ( Note that if none of the parameters are defined for a function by default it will look for the global variables)
